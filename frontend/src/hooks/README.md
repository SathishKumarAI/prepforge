...
| The question index (titles, topics, difficulty, flags) — cached, ETag-checked | `useQuestionIndex.ts` |
...
| *(legacy)* the whole-bank fetch — dead except for cache invalidation (COD-109) | `useQuestions.ts` |
